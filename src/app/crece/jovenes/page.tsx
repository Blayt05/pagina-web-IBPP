    ...
    return(
        <main>
            <div className="relative">
                <Image
                    src="/images/IMAGEN JPZ Y UJZ.svg"
                    alt="Imagen de los jovenes"
                    width={100}
                    height={100}
                    className="w-full"
                />
                <div className="absolute inset-0 flex justify-center items-center">
                    <h1 className="text-white text-5xl lg:text-8xl font-extrabold">Jovenes</h1>
                </div>
            </div>
                ...
                <div className="space-y-20 px-10 lg:px-20 pt-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center lg:pr-20 lg:pl-20">  
                        ...
                        <div className="flex justify-center items-center">
                            <Image
                                src="/images/IMAGEN JPZ Y UJZ 2.svg"
                                alt="Descripción"
                                width={288}
                                height={288}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center lg:pr-20 lg:pl-20">
                        ...
                        <div className="flex justify-center items-center">
                            <Image
                                src="/images/IMAGEN JPZ Y UJZ 3.svg"
                                alt="Descripción"
                                width={288}
                                height={288}
                                className="rounded object-cover w-85 h-85 md:w-81 md:h-81 lg:w-117 lg:h-117 shadow-[-26px_-23px_0px_-3px_#FFD0A0]"
